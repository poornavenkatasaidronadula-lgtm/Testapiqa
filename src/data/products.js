...
export const products = [
  // Women - Dress
  { id: 1, name: 'Blue Top', price: 500, category: 'Women', subcategory: 'Tops', brand: 'Polo', image: 'https://via.placeholder.com/300x350/667eea/ffffff?text=Blue+Top', rating: 4.2, reviews: 38, inStock: true, description: 'A beautiful blue top perfect for casual outings and everyday wear. Made with premium cotton blend fabric for maximum comfort.', color: 'Blue', size: ['S', 'M', 'L', 'XL'] },
  { id: 2, name: 'Men Tshirt', price: 400, category: 'Men', subcategory: 'Tshirts', brand: 'H&M', image: 'https://via.placeholder.com/300x350/764ba2/ffffff?text=Men+Tshirt', rating: 4.5, reviews: 62, inStock: true, description: 'Classic men\'s T-shirt with a relaxed fit. Ideal for everyday casual wear.', color: 'Grey', size: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 3, name: 'Sleeveless Dress', price: 1000, category: 'Women', subcategory: 'Dress', brand: 'Madame', image: 'https://via.placeholder.com/300x350/f093fb/ffffff?text=Sleeveless+Dress', rating: 4.7, reviews: 45, inStock: true, description: 'Elegant sleeveless dress for formal or semi-formal occasions.', color: 'Pink', size: ['S', 'M', 'L'] },
  { id: 4, name: 'Stylish Dress', price: 1500, category: 'Women', subcategory: 'Dress', brand: 'Biba', image: 'https://via.placeholder.com/300x350/4facfe/ffffff?text=Stylish+Dress', rating: 4.3, reviews: 28, inStock: true, description: 'Chic and stylish dress for modern women.', color: 'Blue', size: ['XS', 'S', 'M', 'L', 'XL'] },
  { id: 5, name: 'Winter Top', price: 600, category: 'Women', subcategory: 'Tops', brand: 'Polo', image: 'https://via.placeholder.com/300x350/43e97b/ffffff?text=Winter+Top', rating: 4.1, reviews: 19, inStock: true, description: 'Warm and cozy winter top for cold seasons.', color: 'Green', size: ['S', 'M', 'L', 'XL'] },
  { id: 6, name: 'Summer White Top', price: 400, category: 'Women', subcategory: 'Tops', brand: 'H&M', image: 'https://via.placeholder.com/300x350/fa709a/ffffff?text=Summer+Top', rating: 4.4, reviews: 51, inStock: true, description: 'Fresh and light summer top for warm days.', color: 'White', size: ['XS', 'S', 'M', 'L'] },
  { id: 7, name: 'Madame Top For Women', price: 1000, category: 'Women', subcategory: 'Tops', brand: 'Madame', image: 'https://via.placeholder.com/300x350/f6d365/333?text=Madame+Top', rating: 4.6, reviews: 33, inStock: true, description: 'Designer top from Madame collection for women.', color: 'Yellow', size: ['S', 'M', 'L', 'XL'] },
  { id: 8, name: 'Fancy Green Top', price: 700, category: 'Women', subcategory: 'Tops', brand: 'Biba', image: 'https://via.placeholder.com/300x350/56ab2f/ffffff?text=Fancy+Green', rating: 4.0, reviews: 22, inStock: true, description: 'Trendy green top with fancy design for special occasions.', color: 'Green', size: ['S', 'M', 'L'] },
  // Men
