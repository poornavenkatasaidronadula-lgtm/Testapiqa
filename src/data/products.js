...
export const products = [
  ...
  { id: 16, name: 'Sleeveless Unicorn Patch Gown', price: 1050, category: 'Kids', subcategory: 'Dress', brand: 'Babyhug', image: 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?w=500&q=80', rating: 4.9, reviews: 63, inStock: true, description: 'Magical unicorn patch gown for little princesses.', color: 'Pink', size: ['2-3Y', '4-5Y', '6-7Y'] },
  // Women - Saree
  ...
  { id: 18, name: 'Rust Red Linen Saree', price: 3500, category: 'Women', subcategory: 'Saree', brand: 'Madame', image: 'https://images.unsplash.com/photo-1583391733958-d19f071f00af?w=500&q=80', rating: 4.6, reviews: 18, inStock: true, description: 'Elegant rust red linen saree for festive occasions.', color: 'Rust Red', size: ['Free Size'] },
];
